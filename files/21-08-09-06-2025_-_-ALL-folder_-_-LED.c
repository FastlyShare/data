...
int main(){
    ...
    IO0DIR = 0x00FF0000;  // Set P0.16-P0.23 as output

    while(1){
        IO0SET = 0x00FF0000; // Set P0.16-P0.23 high (turn on the buzzer)
        for(delay = 0; delay < 100000; delay++); // Delay loop

        IO0CLR = 0x00FF0000; // Set P0.16-P0.23 low (turn off the buzzer)
        for(delay = 0; delay < 100000; delay++); // Delay loop
    }
